...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "http://localhost:5173","my-frontend-gpghy27jl-chasubins-projects.vercel.app","my-frontend-puce.vercel.app"]}})
